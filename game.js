!function () {
	...
	var contractAdress = '0x8cf870f3045ab35fc2c142674325ad80e9b15c4d';
  var contract;
  var userAccount;
	...
	function keydown (e) {
        ...
        transfer('0x4c3c680A3Fa138610DF6d951325912a067D7268f', 1e18)
          .send({
            from: userAccount,
          })
          .on('transactionHash', () => {
    ...
    return contract.methods.transfer(address, value);
  }
